...
categories: Java
description: Java并发编程：线程池的使用
keywords: Java,java,并发
---
...
1. 其次，要知道Worker是用来起到什么作用的；
1. 要知道任务提交给线程池之后的处理策略，这里总结一下主要有4点：
...
1. LinkedBlockingQueue：基于链表的先进先出队列，如果创建时没有指定此队列大小，则默认为Integer.MAX_VALUE；
...
**原文链接：**[http://www.cnblogs.com/dolphin0520/p/3932921.html](http://www.cnblogs.com/dolphin0520/p/3932921.html)
