...
categories: Nginx
description: 全面了解Nginx到底能做什么
keywords: Nginx
---

## 前言
本文只针对Nginx在不加载第三方模块的情况能处理的事情。
1. **反向代理**
2. **负载均衡**
3. **HTTP服务器（包含动静分离）**
4. **正向代理**
...
参考链接：
- [http://www.raye.wang/2017/02/24/quan-mian-liao-jie-nginxdao-di-neng-zuo-shi-yao/](http://www.raye.wang/2017/02/24/quan-mian-liao-jie-nginxdao-di-neng-zuo-shi-yao/)